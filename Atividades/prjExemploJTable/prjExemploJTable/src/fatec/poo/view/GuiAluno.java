...
public class GuiAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblAluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RA", "Nome", "Nota 1ª Prova", "Nota 2ª Prova", "Media", "Situação"
            }
        ) {
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        modTblAlu.setValueAt(df.format(media), modTblAlu.getRowCount()-1, 4);
        ...
        txtNtPrv1.setText(null);
        txtNtPrv2.setText(null);
    }//GEN-LAST:event_btnAdicionarActionPerformed

    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if (tblAluno.getSelectedRow() == -1){
            JOptionPane.showMessageDialog(null, "A linha nao foi selecionada", "Aviso", JOptionPane.ERROR_MESSAGE);
        }else{
